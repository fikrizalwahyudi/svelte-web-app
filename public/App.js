...
const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let { url = "" } = $$props;
	...
	return `${validate_component(Router, 'Router').$$render($$result, { url: url }, {}, {
		default: () => `
	  <nav>
	    ${validate_component(Link, 'Link').$$render($$result, { to: "Password" }, {}, { default: () => `Password` })}
	    ${validate_component(Link, 'Link').$$render($$result, { to: "GeneratePDF" }, {}, { default: () => `GeneratePDF` })}
	    ${validate_component(Link, 'Link').$$render($$result, { to: "Persetujuan_nasabah" }, {}, { default: () => `Persetujuan_nasabah` })}
	  </nav>
	  <div>
	    ${validate_component(Route, 'Route').$$render($$result, { path: "Password", component: Password }, {}, {})}
	    ${validate_component(Route, 'Route').$$render($$result, { path: "GeneratePDF", component: GeneratePDF }, {}, {})}
	    ${validate_component(Route, 'Route').$$render($$result, { path: "Persetujuan_nasabah", component: Persetujuan_nasabah }, {}, {})}
	  </div>
	`
	})}`;
});
